...
- [📊 호환성 요약](#호환성-요약)
- [🚀 빠른 마이그레이션 (3단계)](#빠른-마이그레이션-3단계)
  - [1단계: 패키지 설치](#1단계-패키지-설치)
  - [2단계: Import 변경](#2단계-import-변경)
  - [3단계: 테스트 및 실행](#3단계-테스트-및-실행)
- [💯 완벽 호환 기능](#완벽-호환-기능)
  - [✅ 라우팅](#라우팅)
  - [✅ 미들웨어](#미들웨어)
...
- [⚠️ 미구현 기능 및 대체 방법](#미구현-기능-및-대체-방법)
  - [1. express.static() - 정적 파일 서빙](#1-expressstatic-정적-파일-서빙)
  - [2. app.locals - 전역 템플릿 변수](#2-applocals-전역-템플릿-변수)
  - [3. app.param() - 라우트 파라미터 미들웨어](#3-appparam-라우트-파라미터-미들웨어)
  - [4. req.app, req.baseUrl, req.originalUrl - 디버깅 속성](#4-reqapp-reqbaseurl-reqoriginalurl-디버깅-속성)
  - [5. res.format() - Content-Type 협상 응답](#5-resformat-content-type-협상-응답)
  - [6. 기타 미구현 기능](#6-기타-미구현-기능)
- [📝 실전 마이그레이션 예제](#실전-마이그레이션-예제)
  - [Before: Express 애플리케이션](#before-express-애플리케이션)
  - [After: Numflow 애플리케이션](#after-numflow-애플리케이션)
- [🔄 라우터 파일 마이그레이션](#라우터-파일-마이그레이션)
  - [Before: Express Router](#before-express-router)
  - [After: Numflow Router](#after-numflow-router)
- [✅ 마이그레이션 체크리스트](#마이그레이션-체크리스트)
  - [1단계: 준비](#1단계-준비)
  - [2단계: 코드 변경](#2단계-코드-변경)
  - [3단계: 미구현 기능 대체](#3단계-미구현-기능-대체)
  - [4단계: 테스트](#4단계-테스트)
  - [5단계: 배포](#5단계-배포)
- [📊 마이그레이션 후 성능 비교](#마이그레이션-후-성능-비교)
- [💡 마이그레이션 팁](#마이그레이션-팁)
  - [1. 점진적 마이그레이션](#1-점진적-마이그레이션)
  - [2. 테스트 커버리지 확인](#2-테스트-커버리지-확인)
  - [3. 성능 모니터링](#3-성능-모니터링)
- [🆘 문제 해결](#문제-해결)
  - [Q1: 마이그레이션 후 테스트가 실패합니다](#q1-마이그레이션-후-테스트가-실패합니다)
  - [Q2: express.static()을 사용하는 미들웨어가 작동하지 않습니다](#q2-expressstatic을-사용하는-미들웨어가-작동하지-않습니다)
  - [Q3: Body parser가 작동하지 않습니다](#q3-body-parser가-작동하지-않습니다)
- [📚 추가 자료](#추가-자료)
- [🎯 결론](#결론)
