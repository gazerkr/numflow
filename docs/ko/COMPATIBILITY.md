...
| app.onError(handler) | ✅ | - | Numflow 전용 (글로벌 에러 핸들러) |

**전체 호환성**: 24/28 (86%) - 핵심 기능 100% 지원
...
- ✅ **Application API 86% 높은 호환!** (app.router, mount 이벤트 미구현)
...
- 📊 **정확한 호환성: 95% (91/96 API)** - Express 5.x 공식 문서 기준
...
- ✅ **Application API 86% 높은 호환!** (24/28)
- ✅ **전체 호환성 95% 달성!** (91/96)
